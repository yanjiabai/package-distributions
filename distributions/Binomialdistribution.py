...
class Binomial(Distribution):
    ...
    def __init__(self, prob=.5, size=20):
        ...
        #               variable.   
        mean = prob * size
        stdev = math.sqrt(size*prob*(1-prob))
    ...
    def plot_bar(self):
        ...
        num_ones = sum(self.data)
        num_zeros = len(self.data) - sum(self.data)
        x = [0, 1]
        y = [num_ones, num_zeros]
        plt.bar(x,y)
        plt.xlabel('data')
        plt.ylabel('counts')
    ...
    def pdf(self, k):
        ...
        return math.factorial(self.n)/(math.factorial(k)*math.factorial(self.n-k)) * math.pow(self.p, k) \
    ...
    def plot_bar_pdf(self):
        ...
        plt.ylabel('density')
        plt.title('Bar plot of data density')
        return x, y
